...
export default function Home() {
  ...
  const addSegmentDataFromDataLayer = () => {
    optimizelyData?.push({
      "type": "user",
      "attributes": {
        "addSegmentDataFromDatLayer": "custom attribute value"
      }
    });
  }
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div>
          <Link href="/api">
            <a>Optimizely Data Layer Example</a>
          </Link>

          <button onClick={this.addMetricFromDataLayer()}>
            Add Metric From DataLayer
          </button>


          <button onClick={this.addSegmentDataFromDataLayer()}>
            Add Segment Data From DataLayer
          </button>
        </div>
